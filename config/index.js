export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
   APP_ID: "wxf71ad178cdb54428",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
   APP_SECRET: "02cd4c1de6bf3e63bcf67c9595da8b35",

  /**
   * 接收公众号消息的微信号，如果有多个，需要在[]里用英文逗号间隔，例如
   * [o0Wid6eoapdLQvi_XaP5DgDTuQdw,o0Wid6aZPBE-CzIDimQzBh12p7ng
   *  {
   *    // 想要发送的人的名字
   *    name: "老婆0",
